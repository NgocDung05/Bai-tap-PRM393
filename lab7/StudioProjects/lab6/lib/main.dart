...
// STEP 2: Define Movie Model [cite: 61-66]
class Movie {
  final String title;
  final int year;
...
class ResponsiveMovieApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const GenreScreen(), // STEP 3 [cite: 71]
    );
  }
}
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // STEP 5: Genre Chips with Wrap [cite: 81-88]
              ...
              // STEP 6: Sort Dropdown [cite: 89-93]
              Row(
              ...
              // STEP 8: Responsive Movie List [cite: 100-104]
              Expanded(
                child: LayoutBuilder(
...
// Movie Card Widget [cite: 29-32, 105-108]
